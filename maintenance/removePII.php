	...
	public function execute() {
		...
		$extensionUpdates = [
			...
			'user_board' => [
				[
					'fields' => [
						'ub_user_name' => $userNewName,
					],
					'where' => [
						'ub_user_name' => $userOldName
					]
				],
				[
					'fields' => [
						'ub_user_name_from' => $userNewName,
					],
					'where' => [
						'ub_user_name_from' => $userOldName
					]
				]
			],
			'user_gift' => [
				[
					'fields' => [
						'ug_user_name_to' => $userNewName,
					],
					'where' => [
						'ug_user_name_to' => $userOldName
					]
				],
				[
					'fields' => [
						'ug_user_name_from' => $userNewName,
					],
					'where' => [
						'ug_user_name_from' => $userOldName
					]
				]
			],
			'user_points_archive' => [
				[
					'fields' => [
						'up_user_name' => $userNewName,
					],
					'where' => [
						'up_user_name' => $userOldName
					]
				]
			],
			'user_points_monthly' => [
			...
			'user_relationship' => [
				[
					'fields' => [
						'r_user_name' => $userNewName,
					],
					'where' => [
						'r_user_name' => $userOldName
					]
				],
				[
					'fields' => [
						'r_user_name_relation' => $userNewName,
					],
					'where' => [
						'r_user_name_relation' => $userOldName
					]
				]
			],
			'user_relationship_request' => [
				[
					'fields' => [
						'ur_user_name_from' => $userNewName,
					],
					'where' => [
						'ur_user_name_from' => $userOldName
					]
				],
				[
					'fields' => [
						'ur_user_name_to' => $userNewName,
					],
					'where' => [
						'ur_user_name_to' => $userOldName
					]
				]
			],
			'user_stats' => [
				[
					'fields' => [
						'stats_user_name' => $userNewName,
					],
					'where' => [
						'stats_user_name' => $userOldName
					]
				]
			],
			'user_system_gift' => [
				[
					'fields' => [
						'sg_user_name' => $userNewName,
					],
					'where' => [
						'sg_user_name' => $userOldName
					]
				]
			],
			'user_system_messages' => [
				[
					'fields' => [
						'um_user_name' => $userNewName,
					],
					'where' => [
						'um_user_name' => $userOldName
					]
				]
			],
			'Vote' => [
