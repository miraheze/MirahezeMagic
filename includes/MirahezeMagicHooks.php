	...
	*/
	public static function onMessageCacheGet( &$lcKey ) {
		...
		static $keys = [
			...
			"grouppage-checkuser": "m:Special:MyLanguage/CheckUser",
			"group-bureaucrat": "Bureaucrats",
    			"grouppage-bureaucrat": "m:Special:MyLanguage/User groups#Bureaucrats",
			"group-bureaucrat-member": "{{GENDER:$1|bureaucrat}}",
			"group-sysop": "Administrators",
    			"grouppage-sysop": "m:Special:MyLanguage/User groups#Administrators",
			"group-sysop-member": "{{GENDER:$1|administrator}}",
			"group-interface-admin": "Interface administrators",
    			"grouppage-interface-admin": "m:Special:MyLanguage/User groups#Interface administrators",
			"group-interface-admin-member": "{{GENDER:$1|interface administrator}}",
			"group-bot": "Bots",
    			"grouppage-bot": "m:Special:MyLanguage/User groups#Bots",
			"group-bot-member": "{{GENDER:$1|bot}}",
			"grouppage-user": "m:Special:MyLanguage/User groups#Users",
		];
